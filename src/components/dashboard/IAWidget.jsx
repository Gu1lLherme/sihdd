    ...
    <Card className="bg-[#0f172a] text-white border-none shadow-lg overflow-hidden relative">
      ...
      <CardContent className="p-6 relative z-10">
        ...
        <div className="space-y-3 mb-6">
          <Button variant="outline" className="w-full justify-start text-slate-300 border-slate-700 hover:bg-slate-800 hover:text-white bg-transparent h-auto py-2 px-3 text-sm font-normal">
        ...
        <div className="relative">
          ...
          />
          <Button size="icon" variant="ghost" className="absolute right-0 top-0 text-[#D4AF37] hover:text-[#e5c147] hover:bg-transparent">

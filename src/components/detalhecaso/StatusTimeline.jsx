...
import { CheckCircle2, Circle, Clock, FileText, DollarSign, Building2, Award, Sparkles } from "lucide-react";

const STEPS = [
  { id: 'coleta_dados', label: 'Coleta de Dados', icon: FileText, color: 'blue' },
  { id: 'calculo_itcmd', label: 'Cálculo ITCMD', icon: DollarSign, color: 'purple' },
  { id: 'geracao_dae', label: 'Geração DAE', icon: FileText, color: 'amber' },
  { id: 'aguardando_pagamento', label: 'Aguardando Pagamento', icon: Clock, color: 'orange' },
  { id: 'em_analise_sefaz', label: 'Análise SEFAZ', icon: Building2, color: 'indigo' },
  { id: 'certidao_emitida', label: 'Certidão Emitida', icon: Award, color: 'emerald' },
  { id: 'finalizado', label: 'Finalizado', icon: Sparkles, color: 'green' },
];

const colorMap = {
  blue: { bg: 'bg-blue-600', bgLight: 'bg-blue-100', text: 'text-blue-600', border: 'border-blue-600' },
  purple: { bg: 'bg-purple-600', bgLight: 'bg-purple-100', text: 'text-purple-600', border: 'border-purple-600' },
  amber: { bg: 'bg-amber-600', bgLight: 'bg-amber-100', text: 'text-amber-600', border: 'border-amber-600' },
  orange: { bg: 'bg-orange-600', bgLight: 'bg-orange-100', text: 'text-orange-600', border: 'border-orange-600' },
  indigo: { bg: 'bg-indigo-600', bgLight: 'bg-indigo-100', text: 'text-indigo-600', border: 'border-indigo-600' },
